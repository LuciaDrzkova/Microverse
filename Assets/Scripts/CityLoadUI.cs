...
using System.IO; // for File.Delete

public class CityLoadUI : MonoBehaviour
{
    [Header("UI References")]
    public GameObject loadPanel;           // LoadCityPanel
    public Transform contentParent;        // Scroll View -> Content
    public GameObject cityButtonPrefab;    // Button prefab with DeleteButton inside
    ...
    private void Start()
    {
        ...
        if (cancelButton != null)
            ...
            Debug.LogWarning("Cancel button not assigned in CityLoadUI");
    }
    ...
    public void ShowLoadPanel()
    {
        ...
        foreach (string cityName in savedCities)
        {
            ...
            if (loadBtn != null)
            {
                string nameCopy = cityName; // closure fix
            ...
            if (deleteBtn != null)
            {
                ...
                deleteBtn.onClick.AddListener(() => DeleteCity(nameCopy));
            }
        }
    ...
    private void DeleteCity(string cityName)
    {
        ...
        {
            Debug.LogWarning($"City '{cityName}' file not found for deletion.");
        }
